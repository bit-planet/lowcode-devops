...
public class WebMvcRequestHandler implements RequestHandler {
  ...
  public PatternsRequestCondition getPatternsCondition() {
    Set<String> sets = requestMapping.getPatternValues();
    String[] strings = new String[sets.size()];
    sets.toArray(strings);
    org.springframework.web.servlet.mvc.condition.PatternsRequestCondition condition = new org.springframework.web.servlet.mvc.condition.PatternsRequestCondition(strings);
