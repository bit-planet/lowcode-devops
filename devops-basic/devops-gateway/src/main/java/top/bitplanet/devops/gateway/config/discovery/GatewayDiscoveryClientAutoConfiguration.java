...
package top.bitplanet.devops.gateway.config.discovery;
...
public class GatewayDiscoveryClientAutoConfiguration {
	...
	public static List<PredicateDefinition> initPredicates() {
		...
		predicate.addArg(PATTERN_KEY, "'/'+ serviceId.replaceAll('-','/') +'/**'");
	...
	public static List<FilterDefinition> initFilters() {
		...
		//  MARK: ???: 关闭默认的filter  add a filter that removes /serviceId by default
