...
public class NacosDataSourceDemo {
    ...
    private static final String KEY = "/user/{userId}";
    // nacos server ip
    private static final String remoteAddress = "139.159.134.189:8848";
    static final String groupId = "Sentinel_Demo";
    static final String dataId = "com.alibaba.csp.sentinel.demo.flow.rule";
