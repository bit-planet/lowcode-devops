 ...
 * @since 2021-07-22
 */
public final class MyFastAutoGenerator {
    ...
    private MyFastAutoGenerator(DataSourceConfig.Builder dataSourceConfigBuilder) {
    ...
    public static MyFastAutoGenerator create(String url, String username, String password) {
        return new MyFastAutoGenerator(new DataSourceConfig.Builder(url, username, password));
    }

    public static MyFastAutoGenerator create(DataSourceConfig.Builder dataSourceConfigBuilder) {
        return new MyFastAutoGenerator(dataSourceConfigBuilder);
    }
     ...
     * @return
     */
    public MyFastAutoGenerator globalConfig(Consumer<GlobalConfig.Builder> consumer) {
        consumer.accept(this.globalConfigBuilder);
        return this;
    }

    public MyFastAutoGenerator globalConfig(BiConsumer<Function<String, String>, GlobalConfig.Builder> biConsumer) {
     ...
     * @return
     */
    public MyFastAutoGenerator packageConfig(Consumer<PackageConfig.Builder> consumer) {
        consumer.accept(this.packageConfigBuilder);
        return this;
    }

    public MyFastAutoGenerator packageConfig(BiConsumer<Function<String, String>, PackageConfig.Builder> biConsumer) {
     ...
     * @return
     */
    public MyFastAutoGenerator strategyConfig(Consumer<StrategyConfig.Builder> consumer) {
        consumer.accept(this.strategyConfigBuilder);
        return this;
    }

    public MyFastAutoGenerator strategyConfig(BiConsumer<Function<String, String>, StrategyConfig.Builder> biConsumer) {
     ...
     * @return
     */
    public MyFastAutoGenerator injectionConfig(Consumer<InjectionConfig.Builder> consumer) {
        consumer.accept(this.injectionConfigBuilder);
        return this;
    }

    public MyFastAutoGenerator injectionConfig(BiConsumer<Function<String, String>, InjectionConfig.Builder> biConsumer) {
     ...
     * @return
     */
    public MyFastAutoGenerator templateConfig(Consumer<TemplateConfig.Builder> consumer) {
        consumer.accept(this.templateConfigBuilder);
        return this;
    }

    public MyFastAutoGenerator templateConfig(BiConsumer<Function<String, String>, TemplateConfig.Builder> biConsumer) {
     ...
     * @return
     */
    public MyFastAutoGenerator templateEngine(AbstractTemplateEngine templateEngine) {
        this.templateEngine = templateEngine;
        return this;
    }

    public List<TemplateEngineDataVO> execute() {
        return new MyAutoGenerator(this.dataSourceConfigBuilder.build())
                // 全局配置
